...
lang: it_IT
title: openpwnage
description: Guida per l'installazione di openpwnage
...
openpwnage è in grado di eseguire il jailbreak su dispositivi iOS a 32 bit con una versione del firmware 9.0b1-9.3.6.
...
- L’ultima versione di [openpwnage](https://github.com/zachary7829/openpwnage)
