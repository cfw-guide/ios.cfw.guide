...
- **A7 iPads**: iOS 12.5.8 (via Amethyst, Chimera, or Odysseyra1n)
- **A7/A8 iPhones**: iOS 12.5.8 (via Amethyst, Chimera, or Odysseyra1n)
- **iPod Touch (6th Generation)**: iOS 12.5.8 (via Chimera or Odysseyra1n)
- **A8/A10X Apple TVs**: tvOS 26.6 (via palera1n)
- **A8(X) iPads**: iPadOS 15.8.8 (via palera1n)
- **iPod Touch (7th Generation)**: iOS 15.8.8 (via Dopamine or palera1n)
- **A9/A10 iPhones**: iOS 15.8.8 (via Dopamine or palera1n)
- **A9(X) iPads**: iPadOS 16.7.16 (via Dopamine or palera1n)
- **iPad (6th Generation)**: iPadOS 17.7.11 (via Dopamine or palera1n)
- **iPad (7th Generation)**: iPadOS 18.7.10 (via palera1n)
- **A10X iPad Pros**: iPadOS 17.7.11 (via Dopamine or palera1n)
- **A11 iPhones**: iOS 16.7.16 (via Dopamine or palera1n)
- **A12 iPhones**: iOS 18.7.1 (via Dopamine)
- **A12-A13 iPads**: iPadOS 26.0.1 (via Dopamine)
- **A13 iPhones**: iOS 26.0.1 (via Dopamine)
- **A14-A17 iPhones**: iOS 17.3.1 (via Dopamine)
- **A14-A15/M1-M2 iPads**: iPadOS 17.3.1 (via Dopamine)

Note that A14 and newer/M-series devices running iOS 17.4 or newer do not have a jailbreak, which also inherently means no A18/M4 or later device has a jailbreak currently.
