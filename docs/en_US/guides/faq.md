...
- **A8(X) iPads**: iPadOS 15.8.6 (via Dopamine or palera1n)
- **iPod Touch (7th Generation)**: iOS 15.8.6 (via Dopamine or palera1n)
- **A9/A10 iPhones**: iOS 15.8.6 (via Dopamine or palera1n)
- **A9(X) iPads**: iPadOS 16.7.14 (via palera1n)
...
- **A11 iPhones**: iOS 16.7.14 (via palera1n)
