...
- **A8(X) iPads**: iPadOS 15.8.2 (via Dopamine, meowbrek2, or palera1n)
...
- **A9(X) iPads**: iPadOS 16.7.8 (via palera1n)
- **A10(X) iPads**: iPadOS 17.4.1 (via palera1n)
- **A11 iPhones**: iOS 16.7.8 (via palera1n)
