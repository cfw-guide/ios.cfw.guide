...
- **A7 iPads**: iOS 12.5.6 (via Odysseyra1n)
- **A7/A8 iPhones**: iOS 12.5.6 (via Odysseyra1n)
- **iPod Touch (6th Generation)**: iOS 12.5.6 (via Odysseyra1n)
- **A8(X)-A10(X) iPads (excluding the iPad Pro 10.5")**: iPadOS 15.3.1 (via palera1n)
- **iPad Pro 10.5"**: iPadOS 14.8.1 (via Odysseyra1n)
