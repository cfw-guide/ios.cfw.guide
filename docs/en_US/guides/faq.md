...
- **A8/A10X Apple TVs**: tvOS 17.6 (via palera1n)
- **A8(X) iPads**: iPadOS 15.8.3 (via Dopamine, meowbrek2, or palera1n)
- **iPod Touch (7th Generation)**: iOS 15.8.3 (via Dopamine, meowbrek2, or palera1n)
- **A9/A10 iPhones**: iOS 15.8.3 (via Dopamine, meowbrek2, or palera1n)
- **A9(X) iPads**: iPadOS 16.7.10 (via palera1n)
- **A10(X) iPads**: iPadOS 17.6.1 (via palera1n)
