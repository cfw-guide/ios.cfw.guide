...
- **A8/A10X Apple TVs**: tvOS 26.0 (via palera1n)
- **A8(X) iPads**: iPadOS 15.8.5 (via Dopamine or palera1n)
- **iPod Touch (7th Generation)**: iOS 15.8.5 (via Dopamine or palera1n)
- **A9/A10 iPhones**: iOS 15.8.5 (via Dopamine or palera1n)
- **A9(X) iPads**: iPadOS 16.7.12 (via palera1n)
- **iPad 6th Generation**: iPadOS 17.7.10 (via palera1n)
- **iPad 7th Generation**: iPadOS 18.7 (via palera1n)
- **A10X iPad Pros**: iPadOS 17.7.10 (via palera1n)
- **A11 iPhones**: iOS 16.7.12 (via palera1n)
