...
- **A8/A10X Apple TVs**: tvOS 26.5 (via palera1n)
...
- **iPad (5th Generation)/iPad Pro 9.7"**: iPadOS 16.7.16 (via palera1n)
- **iPad Pro 12.9" (1st Generation)**: iPadOS 16.7.16 (via Dopamine or palera1n)
- **iPad (6th Generation)**: iPadOS 17.7.11 (via palera1n)
- **iPad (7th Generation)**: iPadOS 18.7.9 (via Dopamine or palera1n)
