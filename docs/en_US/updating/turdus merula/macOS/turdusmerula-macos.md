...
Depending on the version you are restoring to, you may need to <router-link to="/turdusmerula-tethered-macos">tether downgrade</router-link> to a different version before downgrading to your target version:
...
1. Run `./bin/turdusra1n -Db [generator]`
