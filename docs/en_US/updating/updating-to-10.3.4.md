...
Unfortunately, there is currently no jailbreak available for firmware versions 8.1.1 to 8.4 on 32-bit devices. However some devices, such as the iPhone 5, can update to 10.3.4 and use the Helix jailbreak instead.
