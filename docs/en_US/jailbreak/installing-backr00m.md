...
We will use AltStore to install the backr00m jailbreak application to your Apple TV for use in the next step.
...
1. Select your Apple TV from the list, then select the backr00m .ipa
