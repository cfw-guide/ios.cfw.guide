...
The Fugu14 method of unc0ver does not support beta versions of iOS. If you're on any of the iOS 14.3 betas, follow <router-link to="/installing-taurine">Installing Taurine</router-link>. If you are on 14.4 betas or 14.5 betas, you cannot jailbreak at this time and therefore cannot proceed further.
