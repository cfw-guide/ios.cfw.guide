---
lang: en_US
title: Using palen1x (tvOS)
excerpt: Guide to installing palera1n on tvOS via palen1x
permalink: /using-palen1x-tvos
pkgman: purePKG
redirect_from:
  - /installing-palen1x-tvos
  - /using-palenix-tvos
  - /palen1x-tv
  - /palenix-tvos
  - /using-palen1x-tvos-rootful
  - /using-palen1x-tv-rootful
extra_contributors:
  - Bradley
  - Zenzeq
  - Mineek
...
<!-- I left the other contributors because this guide took a large part of the original palen1x guide and I didn't wanna take credit for their work. -->
