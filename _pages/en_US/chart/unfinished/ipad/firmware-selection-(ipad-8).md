...
permalink: /chart/firmware-selection-(ipad-8)
...
Select the appropriate page for your version from the chart below. Note that the "from" and "to" fields are inclusive. This means that, for example, the "from 14.0 to {% include latestfw %}" row includes version 14.0, version {% include latestfw %}, and all versions in-between.
