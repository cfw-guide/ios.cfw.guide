...
Select the appropriate page for your version from the chart below. Note that the "from" and "to" fields are inclusive. This means that, for example, the "from 11.1 to 12.2" row includes version 11.1, version 12.2, and all versions in-between.
...
<table class="version_table">
  ...
  <tbody>
    ...
    <tr>
      <td>12.0</td>
      <td>12.2</td>
      <td colspan="1"><a href="installing-chimera">Installing Chimera</a></td>
    </tr>
    <tr>
      <td>12.3</td>
      <td>12.3.1</td>
