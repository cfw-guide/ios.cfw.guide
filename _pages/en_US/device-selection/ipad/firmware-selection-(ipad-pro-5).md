...
permalink: /firmware-selection-(ipad-pro-5)
redirect_from:
  - /ipad-pro-5
...
Select the appropriate page for your version from the chart below. Note that the "from" and "to" fields are inclusive. This means that, for example, the "from 14.5 to {% include latestfw %}" row includes version 14.5, version {% include latestfw %}, and all versions in-between.
